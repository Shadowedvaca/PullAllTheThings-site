...
- **Spec Wheel (migration 0181):** Member `/spec-wheel` page with equal-chance main/off-spec spinner, seasonal first/latest history and roll count, roster-aware filters excluding initiates, replacement confirmation, and optional matching-class character assignment.
