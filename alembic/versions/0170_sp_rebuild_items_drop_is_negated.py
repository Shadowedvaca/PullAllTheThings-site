"""fix: sp_rebuild_items — drop is_negated distinction from primary_stat detection

The two-pass COALESCE (prefer non-negated, fall back to any) was based on an
assumption about is_negated that isn't verified.  The field appears to control
UI display (greyed-out stats in the character sheet), not whether the stat
actually exists on the item.  Remove it and take the first primary stat found.
        ...
        BEGIN
            ...
            SELECT
                ...
                CASE
                    ...
                    ELSE NULL
                END,
                -- primary_stat: first INT/AGI/STR found in stats array
