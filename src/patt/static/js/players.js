...
function renderPlayers() {
    ...
    list.innerHTML = filtered.map(p => {
        ...
        <div class="pm-reg-panel" id="pm-reg-panel-${p.id}" style="display:none">
            ...
            ${regOffspecChar
                ? `<div class="pm-reg-panel__row"><span class="pm-reg-panel__label">Secondary</span><span class="pm-reg-panel__value">${escHtml(regOffspecChar.name)} — ${escHtml(regOffspecChar.class)}${p.offspec_spec_name ? ' ' + escHtml(p.offspec_spec_name) : ''}</span></div>`
                : '<div class="pm-reg-panel__row"><span class="pm-reg-panel__label">Secondary</span><span class="pm-reg-panel__value pm-reg-panel__none">not set</span></div>'}
