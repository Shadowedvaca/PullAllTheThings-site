...
- **IV BIS Extraction — Phase Z.2 COMPLETE** (on dev, no migration, branch `feature/iv-bis-extraction`).
  ...
  - **Next:** Re-Sync Errors from admin UI to reprocess all failed IV targets, then Z.3 — Admin section inventory UI + API endpoint (`GET /api/v1/admin/bis/iv-sections`)
...
- **Next planned:** Z.3 — Admin section inventory UI + API endpoint
