...
### Current Phase
- **Platform is feature-complete through Phase 4.4.3.** Next planned: Phase 4.4.4 Data Quality Simplification (see `reference/` for plans). Phases 4.5 (Warcraft Logs) and 4.6 (AH Pricing) deferred. All Phase 4 work deploys to prod together when complete.
