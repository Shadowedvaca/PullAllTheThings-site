...
### Current Phase
- **Platform is feature-complete through Phase 4.4.1.** Next planned: Phase 4.4.2 Character Auto-Claim on OAuth (see `reference/PHASE_4_4_2_CHARACTER_AUTO_CLAIM.md`). Phases 4.5 (Warcraft Logs) and 4.6 (AH Pricing) deferred.
