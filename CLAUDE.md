...
- **IV BIS Extraction — Phase Z.3 COMPLETE** (on dev, no migration, branch `feature/iv-bis-extraction`).
  ...
  - **Phase Z COMPLETE.** IV BIS and trinket ratings now flow through the full enrichment pipeline on Enrich & Classify.
...
- **Next planned:** PR → main → prod (Phase Z complete)
