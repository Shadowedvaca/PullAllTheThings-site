...
### Current Phase
- **IV BIS Extraction — Phase Z.3 COMPLETE** (on dev, no migration, branch `feature/iv-bis-extraction`).
  ...
  - **Next:** Z.4 — `rebuild_bis_from_landing()` + `rebuild_trinket_ratings_from_landing()` IV branches.
...
- **Next planned:** Z.3 — unified Section Inventory admin UI (bis_page_sections, source tabs, gaps/overrides)
