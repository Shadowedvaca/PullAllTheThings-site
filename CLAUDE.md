...
### Current Phase
- **Platform is feature-complete through Phase 4.4.** Next planned: Phase 4.4.1 Battle.net OAuth Account Linking (see `reference/PHASE_4_4_1_BNET_OAUTH_ACCOUNT_LINKING.md`). Phases 4.5 (Warcraft Logs) and 4.6 (AH Pricing) deferred.
