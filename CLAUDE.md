...
- **Next planned:** Phase 1.7-C — hash dedup + adaptive backoff in `sync_target()` + scrape loop in `run_bis_daily_sync()`. **Post-v0.22.2:** run Enrich & Classify to rebuild enrichment.bis_entries with corrected Archon top-pick logic.
