...
### Current Phase
- **IV BIS Extraction — Phase Z.2.5 COMPLETE** (on dev, migration 0162, branch `feature/iv-bis-extraction`).
  ...
  - **Next:** Z.3 — unified Section Inventory admin UI (reads `bis_page_sections`, source tabs: Icy Veins | Method, gaps + override set/clear).
