...
### Current Phase
- **Platform is feature-complete through Phase 5.0.**
- **Tests:** 695 pass, 69 skip (skips are pre-existing: identity_engine import error, one bot DM gate test)
...
- **Member pages** (logged-in required): `/my-characters` — character selector + stat panel (Phase 5.0 foundation; subsequent phases add progression/parse panels)
