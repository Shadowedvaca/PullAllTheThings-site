...
- Hosted PR validation passed at exact commit `ab37176d`, including migrations,
  recovery rehearsal, full tests and coverage, Chromium journeys, JavaScript,
  Compose, production-image build, and fresh-database identity at head 0188.
- Shared Development deployed exact commit `ab37176d` successfully, and Mike
  manually validated the provider-visibility and Gear Plan behavior there.
